...
func (f *fakePlatform) CreateRoute(context.Context, string, string, string, string, []RouteFallback, *RetryConfig, string, int) (*Route, error) {
	return nil, errors.New("unused")
}
func (f *fakePlatform) UpdateRoute(context.Context, string, string, string, string, []RouteFallback, *RetryConfig, string, int) (*Route, error) {
	return nil, errors.New("unused")
}
