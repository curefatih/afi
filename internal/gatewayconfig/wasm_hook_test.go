...
func TestNewTypedChatIRWasmHook(t *testing.T) {
	h, err := NewWasmHook("w2", "o1", "typed", WasmPhaseBeforeChatIR, "file:///tmp/h.wasm", "", true, 10, nil, timeNowUTC())
	if err != nil {
		t.Fatal(err)
	}
	if h.Phase != WasmPhaseBeforeChatIR {
